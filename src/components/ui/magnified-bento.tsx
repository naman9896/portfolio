...
const TAG_ROWS = [
  [
    ...
    { id: "css", icon: Settings02Icon, label: "CSS" },
    { id: "javascript", icon: FlashIcon, label: "JavaScript" },
    { id: "typescript", icon: CodeIcon, label: "TypeScript" },
    { id: "react", icon: HierarchyIcon, label: "React JS" },
  ],
  [
    { id: "nextjs", icon: HierarchyIcon, label: "Next.js" },
    { id: "node", icon: CpuIcon, label: "Node.js" },
    { id: "mongodb", icon: DatabaseIcon, label: "MongoDB" },
    { id: "tailwind", icon: Chart01Icon, label: "Tailwind CSS" },
    { id: "github", icon: UserGroupIcon, label: "GitHub" },
  ],
  [
    { id: "git", icon: UserGroupIcon, label: "Git" },
    { id: "docker", icon: CloudIcon, label: "Docker" },
    { id: "csharp", icon: Settings02Icon, label: "C#" },
    { id: "android", icon: SmartPhone01Icon, label: "Android" },
    { id: "framer", icon: FlashIcon, label: "Framer" },
  ],
  [
    { id: "aws", icon: CloudIcon, label: "AWS" },
    { id: "firebase", icon: DatabaseIcon, label: "Firebase" },
    { id: "figma", icon: Chart01Icon, label: "Figma" },
    { id: "shopify", icon: CpuIcon, label: "Shopify" },
    { id: "vercel", icon: HierarchyIcon, label: "Vercel" },
    { id: "flutter", icon: SmartPhone01Icon, label: "Flutter" },
  ],
];
...
const CONFIG = {
  title: "Skills & Tools",
  description:
    "The languages, frameworks and tools I build with day to day — hover to reveal them all.",
  containerHeight: "h-[240px] sm:h-[300px]",
  lensSize: 92,
};
